            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div className="space-y-1">
                  <h2 className="text-3xl font-bold text-primary">{slugToDisplay(familySlug)}</h2>
                  <p className="text-neutral/70">A collection of our family favorites.</p>
              ...
              <form className="bg-base-200 p-4 rounded-2xl shadow-sm grid md:grid-cols-[1fr_auto] gap-4">
                <input
                  type="text"
                  name="q"
                  defaultValue={q}
              ...
              {filtered.length === 0 ? (
                <div className="text-center py-20">
                  ...
                  <img alt="Empty" src="/placeholder.svg" className="mx-auto w-40 opacity-60" />
                  <p className="mt-4 text-neutral/70">No recipes yet—be the first to add one!</p>
                </div>
              ) : (
