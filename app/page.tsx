...
export default function HomePage() {
  ...
  return (
    <div className="space-y-20 md:space-y-16 animate-fadeIn">
      <section className="mt-20 sm:mt-4 md:mt-0 rounded-3xl bg-gradient-to-r from-primary/25 via-accent/25 to-secondary/25 p-4 sm:p-6 md:p-12 shadow relative overflow-hidden">
